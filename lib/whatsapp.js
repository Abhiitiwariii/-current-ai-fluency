...
// NOTE: an earlier build had a "Send feedback on WhatsApp" button that addressed
// the founder's personal number (api.whatsapp.com/send?phone=…). Any number used
// in a client-side WhatsApp link is visible in the page source, so it was removed
// to keep that number private — feedback is captured server-side in Supabase
// instead. To re-add it, use a DEDICATED / WhatsApp Business number, never a
// personal one, since it will be public in the bundle.
